...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.fetch_url_button = QPushButton("Fetch")
        ...
        self.open_source_button.setObjectName("Primary")
        self.open_source_button.setToolTip("Open the current project source in your browser")
        self.open_source_button.clicked.connect(self.open_current_source)
        source_url_layout.addWidget(self.open_source_button)
